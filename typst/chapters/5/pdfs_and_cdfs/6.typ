a. For $X \sim Unif(0,1)$, $F(k) = k$ for $0<k<1$, $E(X) = 1/2$, $Var(X) = 1/12$, $STD(X) = 1/2sqrt(3)$.

Then the probability X is within one standard deviation of its mean is $P(\frac{sqrt(3)-1}{2sqrt(3)} < X < \frac{sqrt(3)+1}{2sqrt(3)}) = F(\frac{sqrt(3)+1}{2sqrt(3)}) - F(\frac{sqrt(3)-1}{2sqrt(3)}) = (1)/(sqrt(3))$. 
