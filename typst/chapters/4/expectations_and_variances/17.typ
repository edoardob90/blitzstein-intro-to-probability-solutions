...
particular era is $\text{E}(X) = sum_(k=0)^(infinity)k\frac{n_{k}}{\sum_{k=0}^
{infinity}n_{k}} = \frac{m_{1}}{m_{0}}$.

+ The expected number of children in the family of a randomly selected child
is $\text{E}(X) = sum_(k=0)^(infinity)k\frac{kn_{k}}{sum_(k=0)^(infinity)kn_{k}} =
\frac{m_{2}}{m_{1}}$.

+ answer in part $b$ is larger than the answer in part $a$. Since the
