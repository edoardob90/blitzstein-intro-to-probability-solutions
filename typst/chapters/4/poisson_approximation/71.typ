...
aforementioned property. $P(I_{j}=1) = (1)/(365^{2)}$, under the assumption
that the probability of being born on a particular day is $(1)/(365)$. Note
...
(X) = binom(90, 2)(1)/(365^{2)} approx 0.03$.
...
= 1 - e^{-0.03} approx 1 - (1 - 0.03) = 0.03 = (3)/(100)$.