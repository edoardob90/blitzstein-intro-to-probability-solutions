...
+ Let $B$ be the event that the test done by company $B$ is successfull. 
...
+ Since the disease is so rare, most people don't have it. 
...
+ If the test conducted by company $A$ has equal specifity and sensitivity, 
