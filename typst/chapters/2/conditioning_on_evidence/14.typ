...
+ Intuitively, $P(A|B) > P(A|B^{c})$, since Peter will be in a rush to 
install his alarm if he knows that his house will be burglarized before the 
end of next year.

+ Intuitively $P(B|A^{c}) > P(B|A)$, since Peter is more likely to be 
robbed if he doesn't have an alarm by the end of the year.

+ See \url{https://math.stackexchange.com/a/3761508/649082}.

+ An explanation might be that in part $a$, we assume Peter to be driven 
