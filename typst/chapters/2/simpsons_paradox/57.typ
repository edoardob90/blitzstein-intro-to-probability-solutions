...
+ Suppose $C_{1}$ contains $7$ green gummi bears and $8$ red ones, $M_{1}$
...
The proportion of green gummi bears in $C_{1}$ is $(7)/(15)$, which is
larger than that of $M_{1}$, which is $(1)/(3)$. The proportion of green
gummi bears in $C_{2}$ is $(5)/(5)$, which is larger than that of $M_{2}$,
which is $(12)/(17).$ However, the proportion of green gummi bears in $C_{1}
+ C_{2}$ is $(12)/(20)$, which is less than that of $M_{1} + M_{2}$, which
is $(13)/(20).$
