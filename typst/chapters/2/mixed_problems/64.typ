...
Thus, $P(A) = (g)/(1-r) = (g)/(g + b).$ 

+ We are interested in draws in which the first ball is green. Each
...
$P(A) = (binom(g+b-1, g-1))/(binom(g+b, g)) = (g)/(g+b).$

+ Let $A_{i,j}$ be the event that type $i$ occurs before type
