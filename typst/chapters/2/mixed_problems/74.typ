...
b. $P(B|C_{j}) = P(B \wedge C_{j})/P(C_{j}) = \frac{{48 \choose j-1}*(j-1)!*4*3*(52-j-1)!}{{48 \choose j-1}*(j-1)!*4*(52-j)!} = (3)/(52-j)$
...
We also have $P(B) = (51*(50!))/(52!) = 1/52$, as there are 51 sets of two adjacent spaces the two aces could be, and the rest of the cards can be ordered in $50!$ ways. 
