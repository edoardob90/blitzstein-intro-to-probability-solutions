...
+ There are two scenarios which result in the contestant selecting door $3$
...
{3}(1)/(2) + (p_{1} + p_{2})\frac{p_{1}}{p_{1} + p_{2}}} = \frac{p_{1}}{p_
{1} + (1)/(2)p_{3}}.$

+ We can slightly modify the scenario in part $a$ where doors $3$ and $2$
contain goats by multiplying the probability of the scenario by $(1)/(2)$ to
accomodate the chance that Monty might open the door with the car behind it.

$P(S|D_{2}, G_{2}) = (\frac{1)/(2)(p_{1} + p_{2})\frac{p_{1}}{p_{1} + p_{2}}}
{p_{3}(1)/(2) + (1)/(2)(p_{1} + p_{2})\frac{p_{1}}{p_{1} + p_{2}}p} = 
(\frac{1)/(2)p_{1}}{(1)/(2)p_{1} + (1)/(2)p_{3}} = \frac{p_{1}}
{p_{1} + p_{3}}.$

+ $P(S|D_{2}, G_{2}) = \frac{p_{3}}{p_{3} + (1)/(2)p_{1}}.$
