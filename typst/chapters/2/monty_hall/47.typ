...
+ Contestant wins under the "stay-stay" strategy if and only if the Car is
behind Door $1$.

$P(S) = (1)/(4)$

+ If the Car is not behind Door $1$, Monty opens one of the two doors
...
+ Under the "switch-stay" strategy, if the Car is behind Door $1$ the
...
$P(S) = P(C_{1})P(S|C_{1}) + P(C_{1}^{c})P(S|C_{1}^{c}) = 0 + (3)/(4) * 
(1)/(2) = (3)/(8)$

+ Under the "switch-switch" strategy, if the car is behind Door $1$, then
