...
+ The probability of a typo being caught is $p_{1} + p_{2} - p_{1}p_{2}$.
Then, $P(X = k) = binom(n, k)(p_{1} + p_{2} - p_{1}p_{2})^{k}(1 - (p_{1} + p_
{2} - p_{1}p_{2}))^{n-k}$

+ When we know the total number of caught typos in advance, the typos caught
...
$P(X_{1} = k | X_{1} + X_{2} = t) = (binom(n, k)binom(n, t-k))/(
binom(2n, t))$