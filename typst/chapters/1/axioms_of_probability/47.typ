...
$P(A sect B) = (1)/(4)$ since $A sect B$ corresponds to the outcome $HH$. 

On the other hand, $A$ corresponds to the outcomes $\{HH, HT\}$ 
and $B$ corresponds to the outcomes $\{HH, TH\}$. Thus, 
$P(A) = P(B) = (1)/(2).$

Since $P(A sect B) = P(A)P(B),$ $A$ and $B$ are independent events.

+ $A_{1}$ and $B_{1}$ should intersect such that the ratio of 
the area of $A_{1} sect B_{1}$ to the area of $A_{1}$ equals the ratio of 
